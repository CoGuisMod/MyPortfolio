      ...
      <div className="flex justify-center items-center h-full backdrop-blur-sm hero-shadow">
        <div className="overflow-hidden">
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-sm sm:text-lg text-left transition-all duration-100 ease-linear"
          >
            Hey! What's up? I'm...
          </motion.p>
          <motion.h1
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className=" text-sm sm:text-lg text-right transition-all duration-100 ease-linear"
          >
